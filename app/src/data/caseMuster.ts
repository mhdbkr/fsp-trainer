...
export const CASE_MUSTER: Record<string, CaseMuster> = {
  ...
  'case-pneumonie': {
    arztbrief: {
      ...
      'diagnostik-therapie': 'Es wurden eine körperliche Untersuchung, eine Messung der Vitalparameter einschließlich der Sauerstoffsättigung sowie eine laborchemische Untersuchung (Blutbild, CRP, BSG, BGA, Harnstoff, HbA1c) veranlasst. Zusätzlich wurden Blutkulturen und eine Sputumdiagnostik mit Antibiogramm noch vor Beginn der Antibiotikatherapie abgenommen sowie ein Nasopharyngealabstrich, eine Thoraxsonographie und eine Röntgenaufnahme des Thorax angemeldet. Aufgrund der Immunsuppression wurde der Patient stationär aufgenommen. Therapeutisch wurden eine kalkulierte antibiotische Therapie (wegen der Penicillinallergie mit einem Makrolid), eine Sauerstoffgabe, eine ausreichende Flüssigkeitszufuhr, eine antipyretisch-analgetische Behandlung sowie eine körperliche Schonung eingeleitet.',
    },
    vorstellung: {
